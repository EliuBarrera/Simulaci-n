...
public class ResultadoFuerza {
    ...
    public Nodo getParticulaCausante()   { return particulaCausante; }
    ...
    public double getDistanciaEnUnidad() { return distanciaEnUnidad; }
    public double getDistanciaEnMetros() { return distanciaEnMetros; }
    public double getAnguloDeg()         { return anguloDeg; }
    public double getAnguloElevacionDeg() { return anguloElevacionDeg; }
    ...
    public boolean isEsRepulsion()       { return esRepulsion; }
    public String getTipoInteraccion()   { return esRepulsion ? "REPULSION (mismo signo)" : "ATRACCION (signos opuestos)"; }
}